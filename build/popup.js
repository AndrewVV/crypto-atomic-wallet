...
$(document).ready(function () {
  $("#buy-crypto").on('input', function () {
    var buyTicker = document.getElementById("buy-crypto").value;
    var sellTicker = document.getElementById("sell-crypto").value;
  ...
  $("#amount-for-purchase").on('input', function () {
    if (document.getElementById("buy-crypto").value === "btctest") {
      var amount = document.getElementById("amount-for-purchase").value;
  ...
  $("#create-order").on("click", function _callee() {
    var buyTicker, sellTicker, buyAmount, sellAmount, data, createOrder;
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            buyTicker = document.getElementById("buy-crypto").value;
            sellTicker = document.getElementById("sell-crypto").value;
            buyAmount = document.getElementById("amount-for-purchase").value;
            sellAmount = document.getElementById("your-spend-amount").innerHTML;
            data = {
              buyTicker: buyTicker,
              buyAmount: buyAmount,
            ...
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().createOrder,
                data: data
              }, function (response) {
                resolve(response);
              });
  ...
  $("#get-orders").click(function _callee2() {
    var result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().getOrders
              }, function (response) {
                resolve(response);
              });
            }));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().replyToOrder,
                data: data
              }, function (response) {
                resolve(response);
              });
  ...
  $("#wallet-interface").on('input', function _callee4() {
    var ticker;
  ...
  $("#generate-mnemonic").on("click", function _callee5() {
  ...
  $("#get-rate").click(function _callee9() {
    var result;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().getCurrentRate
              }, function (response) {
                resolve(response);
              });
            }));
  ...
  $("#validate").click(function _callee10() {
    var address, data, result;
    return regeneratorRuntime.async(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            address = document.getElementById('validate-address').value;
            data = {
              address: address
            };
            _context10.next = 4;
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().validateAddress,
                data: data
              }, function (response) {
                resolve(response);
              });
  ...
  $("#get-history").click(function _callee11() {
    var history;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(new Promise(function (resolve, reject) {
              chrome.runtime.sendMessage({
                "action": Actions.getBackground().getTxHistory
              }, function (response) {
                resolve(response);
              });
            }));
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            password = document.getElementById('password').value;
            mnemonic = document.getElementById('import-your-mnemonic').value;
            data = {
              "password": password,
              "mnemonic": mnemonic
            };
  ...
  $("#expand-view").attr("href", "chrome-extension://".concat(window.location.hostname, "/page/home.html"));
});
